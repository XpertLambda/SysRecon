...
ReportGenerator::~ReportGenerator() {}
bool ReportGenerator::Initialize() { initialized_ = true; return true; }
bool ReportGenerator::SetScanResults(const std::vector<ScanResult>&) { return true; }
...
void ReportGenerator::Cleanup() { initialized_ = false; }
